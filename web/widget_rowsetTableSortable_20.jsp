...
<%-- Date		Author	Change
	...
	9/25/2009	TJR		Created widget_rowsetTableSortable_20.jsp so we could have a standard
						widget with 20 rows displayed by default.  
						Use widget_rowsetTableSortable.jsp for "default" 10 rows
 --%>
...
$(function(){
		$("#${view.websafeName}table")
			...
			.tablesorterPager({container: $("#${view.websafeName}pager"), positionFixed: false, size:20});
});
</script>
