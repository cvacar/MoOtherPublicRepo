...
<%-- Respond to CloneType dropdown selection in Manage Culture Collection--%>
<script type="text/javascript">
function showCloneTypeDetail()
{
var elem1a = document.getElementById('TemplateID');
var elem1b = document.getElementById('LibraryID');
var elem2a = document.getElementById('Vendor');
var elem2b = document.getElementById('CatalogNum');
if(document.forms[0].CloneType.value == "Amplified")
{
elem1a.style.display="";
elem1b.style.display="";
elem2a.style.display="none";
elem2b.style.display="none";
}
else if(document.forms[0].CloneType.value == "Subclone")
{
elem1a.style.display="";
elem1b.style.display="";
elem2a.style.display="none";
...
else if(document.forms[0].CloneType.value == "Synthetic")
{
elem2a.style.display="";
elem2b.style.display="";
elem1a.style.display="none";
elem1b.style.display="none";
}
else 
{
elem2a.style.display="none";
    		...
    		<table id="taskPgTable">
				...
				<jsp:include page="linxMessage.jsp" flush="true"/>
				 <tr class="taskPageRow">
		              <td>
				         <c:choose>
					<c:when test="${task.taskName == null}">Please select a task to begin, or click below to go to the reporting portal:
					<br> <br>
					<a HREF="https://sqlemre01.synthgeno.global/Reports/Pages/Folder.aspx?ItemPath=%2fEMREReports&ViewMode=List">From SGI: SSRS EMRE Reports</a>
					<br><br>
					<a HREF="http://192.168.250.193/Reports/Pages/Folder.aspx?ItemPath=%2fEMREReports&ViewMode=List">From EMRE: SSRS EMRE Reports</a>
					</c:when>
				           <c:otherwise>
				           <table>
							<tr><td>
					...
					<br> <br><a href="https://sqlemre01.synthgeno.global/Reports/Pages/Report.aspx?ItemPath=%2fEMREReports%2fProduction+R+and+D%2fActiveCultures">From SGI: Print Active Culture Barcodes</a>
					<br> <br><a href="http://192.168.250.193/Reports/Pages/Report.aspx?ItemPath=%2fEMREReports%2fProduction+R+and+D%2fActiveCultures">From EMRE: Print Active Culture Barcodes</a></td></tr>
