  	...
  	protected String getStrainType()
{
	...
	public ArrayList<String> reserveLocations(String strainID, Db db)
	{
		...
		String strainType = this.getStrainType(strainID);
	...
	private String getStrainType(String strainId)
	{
		//return "Met E";
		String strainType = null;
		if(strainId.startsWith("PH"))
			strainType = "Photo H";
		else if(strainId.startsWith("PE"))
			strainType = "Photo E";
		else if(strainId.startsWith("WT"))
			strainType = "Met E";
		else
			throw new LinxUserException(
					"Unable to auto generate freezer locations because of an unknown strain prefix.\r\n" 
					+ "Valid strain prefixes are 'PH-', 'PE-', and 'WT-'.");
		return strainType;
	}
	/**
