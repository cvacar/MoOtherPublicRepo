...
/**
 * Modified 7/2011 for EMRE v2.2 to use param list
 * instead of string values in inline SQL to call
 * for result set that generates report.
 * @author TJ/Wildtype for SGI.
 *
 */
public class SvReportPrimaryEnrichment extends EMREServlet
{
	...
	/**
	 * Handles the task GET requests ('goToRow' and 'export' currently
	 * supported)
	 * 
	 * @param request
	 *            The current request
	 ...
	 * from screen UI widgets and calling stored procedure spEMRE_reportPrimaryEnrichment.
	 */
	@Override
	...
	{	
		...
		{
			// we want to name the params, so can't use dbHelper.callStoredProced(params)
