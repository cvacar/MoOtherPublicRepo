...
public class EMREStrings extends Strings
{
  ...
  public static class ItemType
	{
		...
		public static final String SAMPLING_TIMEPT	= "SamplingTimepoint";
  ...
  public static class FileType
  {
    ...
    public static final String UDPATE_PRIMARY_ENRICHMENT_IMPORT_FILE	= "PrimaryEnrichmentImportFile";
    ...
    public static final String UPDATE_ISOLATES_IMPORT_FILE				= "UpdateIsolatesImportFile";
  ...
  public static class GrowthRecovery
  {
	  public static final String[] requiredStrainCultureCollectionColumnHeaders = new String[]{
	  		"Strain ID","Start Date","Strain Culture ID"};
	  	  
	  public static final String[] requiredExpCultureCollectionColumnHeaders = new String[]{
		  "Origin LIMS ID","Start Date","Experimental Culture ID"};
  ...
  public static class GeneDiscovery
  {
	  ...
	  public static final String[] requiredStrainCollectionColumnHeaders = new String[]{
  		"Strain ID","Strain Name","Genus", "Optional", "Project"};
